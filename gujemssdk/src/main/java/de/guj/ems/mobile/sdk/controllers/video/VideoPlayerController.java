...
public class VideoPlayerController {
    ...
    public void requestAndPlayAds() {
        ...
        mAdsLoader.addAdErrorListener(new AdErrorEvent.AdErrorListener() {
            @Override
            public void onAdError(AdErrorEvent adErrorEvent) {
                if (adErrorEvent.getError().getErrorCode().getErrorNumber() == NO_VALID_IDS_ERROR_CODE) {
                    SdkLog.e(TAG, "no valid video id");
                    if(mExternalErrorListener != null){
                        mExternalErrorListener.onEmptyVideo();
                    }
                }
            }
        });
    ...
    public void addErrorListener(VideoErrorListener listener) {
