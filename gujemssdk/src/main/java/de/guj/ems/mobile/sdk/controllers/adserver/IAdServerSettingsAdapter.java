...
public interface IAdServerSettingsAdapter {
     ...
     * Override the listener class
     *
     * @param l implementation of listener which reacts to successful ad
     *          loading
     */
     ...
     *
     * @param context       app context
     * @param savedInstance saved attributes
     */
     ...
     * @param context       app context
     * @param savedInstance saved attributes
     * @param keywords      additional keywords to pass to the adserver
     */
