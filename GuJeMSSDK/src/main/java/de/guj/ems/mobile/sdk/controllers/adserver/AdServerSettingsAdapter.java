...
public abstract class AdServerSettingsAdapter implements IAdServerSettingsAdapter {
        ...
        if (params != null) {
            ...
            while (mi.hasNext()) {
                ...
                if (value.getClass().equals(String.class)) {
                    ...
                    SdkLog.e(TAG,
                            this.hashCode() + " unknown object in custom params. Only String, Integer, Double allowed.");
                }
            }
        } else {
            SdkLog.w(TAG, this.hashCode() + " custom params constructor used with null-array.");
        }
    }
        ...
        this.onAdEmptyListener = new IOnAdEmptyListener() {
            ...
            public void onAdEmpty() {
                try {
                    ...
                    SdkLog.e(TAG, this.hashCode() + " OnAdEmptyListener " + lMethodName
                            + " not found. Check your xml.", nsme);

                } catch (InvocationTargetException ivte) {
                    SdkLog.e(TAG, this.hashCode() + " OnAdEmptyListener could not be invoked",
                            ivte);
                } catch (IllegalAccessException iae) {
                    SdkLog.e(TAG, this.hashCode() + " OnAdEmptyListener could not be accessed",
                            iae);
                }

            }
        };
        SdkLog.d(TAG, this.hashCode() + " Created onEmptyListener \"" + lMethodName + "\"");
    }
    ...
    private final void createEmptyListener(final Object listener) {
        try {
            ...
            SdkLog.e(TAG, this.hashCode() + " Error setting onAdEmptyListener", e);
        }
    }
    ...
    private final void createErrorListener(final Context context,
        ...
        this.onAdErrorListener = new IOnAdErrorListener() {
            ...
            public void onAdError(String msg) {
                try {
                    ...
                    SdkLog.e(TAG, this.hashCode() + " OnAdErrorListener " + lMethodName
                            + " not found. Check your xml.", nsme);

                } catch (InvocationTargetException ivte) {
                    SdkLog.e(TAG, this.hashCode() + " OnAdErrorListener could not be invoked",
                            ivte);
                } catch (IllegalAccessException iae) {
                    SdkLog.e(TAG, this.hashCode() + " OnAdErrorListener could not be accessed",
                            iae);
                }
        ...
        SdkLog.d(TAG, this.hashCode() + " created onErrorListener \"" + lMethodName + "\"");
    }
    ...
    private final void createErrorListener(final Object listener) {
        try {
            ...
            SdkLog.e(TAG, this.hashCode() + " Error setting onAdErrorListener", e);
        }
    }
        ...
        this.onAdSuccessListener = new IOnAdSuccessListener() {
            ...
            public void onAdSuccess() {
                try {
                    ...
                    SdkLog.e(TAG, this.hashCode() + " OnAdSuccessListener " + lMethodName
                            + " not found. Check your xml.", nsme);

                } catch (InvocationTargetException ivte) {
                    SdkLog.e(TAG, this.hashCode() + " OnAdSuccessListener could not be invoked",
                            ivte);
                } catch (IllegalAccessException iae) {
                    SdkLog.e(TAG, this.hashCode() + " OnAdSuccessListener could not be accessed",
                            iae);
                }

            }
        };
        SdkLog.d(TAG, this.hashCode() + " created onSuccessListener \"" + lMethodName + "\"");
    }
    ...
    private final void createSuccessListener(final Object listener) {
        try {
            ...
            SdkLog.e(TAG, this.hashCode() + " Error setting onAdSuccessListener", e);
        }
    }
                ...
                if (key.startsWith(SdkGlobals.EMS_ATTRIBUTE_PREFIX)) {
                    if (key.startsWith(SdkGlobals.EMS_LISTENER_PREFIX)) {
                        ...
                        if (lName.equals(SdkGlobals.EMS_SUCCESS_LISTENER)) {
                            ...
                            SdkLog.w(TAG, this.hashCode() + " unknown listener type name: "
                                    + lName);
                        }
                    } else {
                        map.put(key.substring(4), key.substring(4));
                        SdkLog.d(TAG,
                                this.hashCode() + " found AdView attribute " + key.substring(4));
                    }
                    ...
                    if (attr.startsWith(SdkGlobals.EMS_LISTENER_PREFIX)) {
                        ...
                        if (lName.equals(SdkGlobals.EMS_SUCCESS_LISTENER)) {
                            createSuccessListener(context,
                                    tVals.getString(R.styleable.GuJEMSAdView_ems_onAdSuccess));
                        } else if (lName.equals(SdkGlobals.EMS_EMPTY_LISTENER)) {
                            createEmptyListener(context,
                                    tVals.getString(R.styleable.GuJEMSAdView_ems_onAdEmpty));
                        } else if (lName.equals(SdkGlobals.EMS_ERROR_LISTENER)) {
                            createErrorListener(context,
                                    tVals.getString(R.styleable.GuJEMSAdView_ems_onAdError));
                        } else {
                            SdkLog.w(TAG, this.hashCode() + " unknown listener type name: "
                                    + lName);
                        }
                        ...
                        SdkLog.d(TAG,
                                this.hashCode() + " found AdView attribute " + attr.substring(4));
                    }
     ...
     * @param set     inflated layout parameters
     */
     ...
     *
     * @param context       application context
     * @param savedInstance saved instance state
     */
    ...
    private StringBuilder expandKeywords(String[] keywords) {
        if (keywords != null && keywords.length > 0) {
            StringBuilder kw = new StringBuilder();
            for (int i = 0; i < keywords.length; i++) {
                kw = kw.append(keywords[i] + ",");
            }
            SdkLog.d(TAG, this.hashCode() + " DFP keyword list " + kw);
            return kw;
        } else return null;
    }
    ...
    public void setup(Context context, AttributeSet set, String[] keywords) {
        setup(context, set);
        try {
            this.paramValues.put(SdkGlobals.EMS_KEYWORDS, expandKeywords(keywords).toString());
