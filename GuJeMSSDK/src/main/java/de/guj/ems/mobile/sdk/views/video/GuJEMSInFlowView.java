...
public class GuJEMSInFlowView extends LinearLayout {
    ...
    private final class InFlowScrollChangedListener implements OnScrollChangedListener {
    ...
    protected void init(final Context context) {
        ...
        int mDisplayWidth = SdkUtil.getScreenWidth();
        this.targetHeight = (int) (0.67f * 0.9f * mDisplayWidth + ICON_HEIGHT);

		/* views */
        mRootView = (LinearLayout) this.findViewById(R.id.ems_inflow_view);
        ViewGroup mRootPlayerView = (ViewGroup) this.findViewById(R.id.ems_inflow_view_relative);
		...
		/* Close Button */
        (findViewById(R.id.ems_inflow_close))
		...
		/* Sound button */
        (findViewById(R.id.ems_inflow_sound))
                .setOnClickListener(new OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        if (mMPlayer != null) {
		...
		/* view animations */
        this.closeAnimation = new ShrinkAnimation(mRootView, targetHeight);
        this.expandAnimation = new ExpandAnimation(mRootView, targetHeight);
