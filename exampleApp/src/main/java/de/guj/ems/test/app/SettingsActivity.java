...
public class SettingsActivity extends Activity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        TextView targetPage = (TextView) findViewById(R.id.settingsValueNativeTargetPage);
        ...
        try {
            ...
            targetPage.setText(util.getStringSettingByKey(GlobalData.preferenceNative));
        } catch (Exception e1) {
        ...
        button.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    util.setStringSetting(GlobalData.preferenceNative, targetPage.getText().toString());
                } catch (Exception e) {
                    // TODO Auto-generated catch block
                    e.printStackTrace();
                }
