	...
	public class JSONVariables extends JSONContent {
		...
		void init() {
			fetcher = new JSONFetcher(this, SdkUtil.getContext().getResources()
					...
					+ SdkUtil.getContext().getResources()
							.getString(R.string.ems_jsonVariablesScript), SdkUtil
					.getContext()
					.getString(R.string.ems_jsonLocalVariablesFileName),
		...
		public IAdServerSettingsAdapter process(
			...
			if (getJSON() != null) {
				...
				SdkLog.w(TAG, "JSON config not yet loaded upon processing request");
			}
